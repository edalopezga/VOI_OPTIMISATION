...
Platypus: geneticalgorithm is a Python library distributed on Pypi for implementing 
standard and elitist genetic-algorithm (GA).  
more information: https://github.com/rmsolgi/geneticalgorithm
...
class Network:
    ...
    def BaseDemand (self, y = "No_defined"):
        '''
        This function returns the base demand of the nodes y (in list format) to 
...
# =============================================================================
#       Main attributes created for the object Network
# =============================================================================
